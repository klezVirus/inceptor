...
class SelfDeleteModule(TemplateModule):
    def __init__(self, **kwargs):
        ...
        if language == Language.CPP:
            ...
            components = [
                ...
                SelfDeleteComponent(code=f"{function_name}();")
            ]
        elif language == Language.CSHARP:
            components = [
                UsingComponent(import_name, language=language),
                SelfDeleteComponent(code=rf"""
    ...
    def generate(self, **kwargs):
        ...
        for k, v in zip(
                ["import", "class", "function", "ads"],
                ["####NAMESPACE####", "####CLASS####", "####FUNCTION####", "####ADS####"]
        ):
