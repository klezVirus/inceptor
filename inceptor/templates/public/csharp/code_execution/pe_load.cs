    ...
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                pinfo = NativeDeclarations.CommandLineToArgvW(_args, out argc );
            ...
            IntPtr hThread = NativeDeclarations.CreateThread(IntPtr.Zero, 0, threadStart, pinfo, 0, IntPtr.Zero);
